        ...
        <div className="group relative bg-background border border-border rounded-2xl overflow-hidden transition-all duration-700 h-full flex flex-col hover:border-primary/50 hover:shadow-2xl">
            ...
            <div className="relative aspect-[3/4] overflow-hidden bg-accent">
                ...
                <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-3 opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 z-20">
                    <Link href="/wish-list" className="w-10 h-10 flex items-center justify-center bg-background text-secondary hover:bg-secondary hover:text-background rounded-full transition-all duration-300 shadow-xl">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
                        </svg>
                    </Link>
                    <Link href="/cart" className="px-6 py-3 bg-secondary text-background text-[10px] font-bold uppercase tracking-[0.2em] rounded-full hover:bg-primary transition-all duration-300 shadow-xl whitespace-nowrap flex items-center justify-center">
                        Add to Cart
                    </Link>
            ...
            <div className="pt-5 pb-5 px-5 flex flex-col flex-1">
                ...
                <div className="mt-auto flex items-center justify-between">
                    <span className="text-xl font-serif font-bold text-secondary">Rs. {product.price}</span>

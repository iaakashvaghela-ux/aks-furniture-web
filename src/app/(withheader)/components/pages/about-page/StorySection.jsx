        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="space-y-12 order-2 lg:order-1">
            <div className="space-y-4">
              <h2 className="text-sm font-sans font-bold text-primary tracking-[.4em] uppercase">Who We Are</h2>
              <h3 className="text-5xl md:text-6xl font-serif font-bold text-secondary leading-tight italic">
                A Journey of <br /> Artisan Spirit.
              </h3>
            </div>
            ...
            <div className="grid grid-cols-2 gap-12 pt-8 border-t border-border">
              ...
              <div>
                <p className="text-4xl font-serif font-bold text-secondary">500+</p>
